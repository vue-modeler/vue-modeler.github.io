...
[@vue-modeler/model](https://www.npmjs.com/package/@vue-modeler/model) позволяет писать меньше кода, это значит нужно меньше тестов. Вам не нужно проверять правильность установки состояний в `action`, если они не используются во внутренней бизнес логике модели.
...
Полный список тестов для такой корзины можно посмотреть [здесь](https://github.com/vue-modeler/model/tree/main/examples/cart).
