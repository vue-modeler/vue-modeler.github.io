...
`model` копирует сигнатуру конструктора класса, поэтому поверка типов в TS будет работать.
...
Как работать с действиями внутри классов и снаружи смотрите раздел [Действия](/guides/actions/).
...
::: warning
 ...
 Обязательно выполняйте пункты 2 и  3, что бы удалить наблюдатель, иначе будет утечка памяти. 
:::
...
Полное описание всех методов и свойств модели см. в разделе [API модели](/guides/models/api/).
