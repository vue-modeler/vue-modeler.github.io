...
**В [@vue-modeler/model](https://www.npmjs.com/package/@vue-modeler/model) действие — это объект**, который хранит операцию для изменения состояния модели, имеет методы управления выполнением и свойства для контроля состояния выполнения. 
...
- действие сохраняет контекст модели, используйте где угодно без потери контекста;
