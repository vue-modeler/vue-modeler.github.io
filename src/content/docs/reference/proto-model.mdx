...
**ProtoModel** - это абстрактный базовый класс, который служит фундаментом для всех моделей в Vue Modeler. Он предоставляет мощную систему реактивности, управления жизненным циклом и асинхронных действий.

## Назначение

ProtoModel решает следующие задачи:

- **Реактивность**: автоматическое отслеживание изменений свойств и обновление UI
- **Управление действиями**: система для работы с асинхронными операциями
- **Жизненный цикл**: автоматическое управление ресурсами и предотвращение утечек памяти
- **Изоляция эффектов**: создание собственного контекста выполнения для каждой модели
- **Типобезопасность**: полная поддержка TypeScript

## Архитектура

ProtoModel построен на основе Vue 3 Composition API и использует:

- `EffectScope` для изоляции реактивных эффектов
- `shallowReactive` для оптимизированной реактивности
- `WeakMap` для эффективного хранения метаданных действий
- Систему наблюдателей с автоматической очисткой
