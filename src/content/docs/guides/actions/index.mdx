...
Чтобы `abort` работал, есть обязательные условия: 
...
Чтобы это работало, необходимо чтобы:
