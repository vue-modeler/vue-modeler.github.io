---
title: Interfaces
description: Справочник по публичным интерфейсам @vue-modeler/model
outline: deep
---

Этот документ описывает публичные интерфейсы библиотеки [@vue-modeler/model](https://www.npmjs.com/package/@vue-modeler/model).
